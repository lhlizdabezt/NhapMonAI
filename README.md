...
## ✨ Đọc repo trong 5 phút

| Bước | Xem gì trước | Vì sao quan trọng |
| --- | --- | --- |
| 1 | GIF pipeline và thẻ visual ở đầu README | Nắm nhanh luồng từ ảnh/video, YOLO, OCR đến demo cổng PC |
| 2 | Mục [Kết quả định lượng](#-kết-quả-định-lượng) | Kiểm tra chỉ số YOLO trên tập kiểm định thay vì đọc claim chung chung |
| 3 | Mục [Bằng chứng hình ảnh](#️-bằng-chứng-hình-ảnh) | Thấy giao diện app, ảnh kết quả, ma trận nhầm lẫn và demo cổng |
| 4 | Mục [Cách chạy nhanh](#️-cách-chạy-nhanh) | Biết đường chạy app Python, PlateGate PC và endpoint HTTP |
| 5 | Mục [Bản phát hành](#-bản-phát-hành) | Tải nhanh PDF, slide, app bundle, GIF/SVG và source snapshot đã đóng gói |
...
## 👤 Vai trò của Lương Hải Long

| Nội dung | Ghi rõ để phỏng vấn không bị thổi phồng |
| --- | --- |
| Bối cảnh | Đồ án nhóm 7 thành viên cho học phần Nhập môn Trí tuệ Nhân tạo |
| Phần đóng gói portfolio | Duy trì repo công khai, chuẩn hóa README, release, tags, topics, liên kết Kaggle/Drive/FastALPR và visual reviewer-ready |
| Phần phát triển liên quan | Đồng phát triển app Python nhận diện ảnh/video và demo PlateGate PC trong phạm vi đồ án |
| Phạm vi nguyên mẫu | Dữ liệu học thuật, demo LAN, chưa kiểm định như hệ thống kiểm soát giao thông vận hành thật |
| Cách đọc đóng góp | Xem repo như bằng chứng năng lực AI/CV ứng dụng, Python tooling, đóng gói minh chứng và giao tiếp kỹ thuật |
...
Kiểm tra nhanh PlateGate PC bằng PowerShell sau khi app đang chạy:

```powershell
Invoke-RestMethod -Uri "http://127.0.0.1:8765/health"
Invoke-RestMethod -Uri "http://127.0.0.1:8765/scan" -Method Post -ContentType "application/json" -Body '{"plate":"DWDWD","score":0.99,"source":"manual-test"}'
```
...
| Hạng mục | Trạng thái |
| --- | --- |
| Mô tả repo | Nhận diện biển số xe Việt Nam bằng YOLO/PyTorch và OCR/FastALPR, có app Python, demo cổng PC LAN, Kaggle/IPYNB, dataset Drive, báo cáo Typst, motion visual, Git LFS và release |
| Chủ đề chính | `alpr`, `license-plate-recognition`, `vietnamese-license-plate`, `yolo`, `ocr`, `computer-vision`, `machine-learning`, `pytorch`, `kaggle`, `fast-alpr`, `object-detection`, `git-lfs` |
...
| Tài sản | Vai trò |
| --- | --- |
| [Báo cáo seminar PDF](https://github.com/lhlizdabezt/NhapMonAI/releases/latest/download/Group5_BaoCaoSeminarNhapMonAI.pdf) | Đọc nhanh mục tiêu, phương pháp, kết quả và giới hạn |
| [Slide seminar PPTX](https://github.com/lhlizdabezt/NhapMonAI/releases/latest/download/Group5_SlideSeminarNhapMonAI.pptx) | Trình bày ngắn gọn cho lớp hoặc buổi đánh giá |
| [App Python YOLO/OCR](https://github.com/lhlizdabezt/NhapMonAI/releases/latest/download/AppPythonYOLO_OCR.7z) | Chạy demo nhận diện ảnh hoặc video |
| [App demo cổng PC](https://github.com/lhlizdabezt/NhapMonAI/releases/latest/download/AppPythonPlateGatePC.zip) | Minh họa hướng tích hợp nhận diện biển số vào quy trình kiểm soát cổng LAN |
| [GIF pipeline](https://github.com/lhlizdabezt/NhapMonAI/releases/latest/download/alpr-pipeline-motion.gif) | Motion visual để HR hoặc người xem profile hiểu nhanh luồng xử lý |
| [Thẻ visual SVG](https://github.com/lhlizdabezt/NhapMonAI/releases/latest/download/alpr-review-card.svg) | Tóm tắt bằng chứng kỹ thuật bằng asset ASCII-safe |
| Source snapshot | Ảnh chụp mã nguồn tại đúng tag phát hành để kiểm tra lại khi README hoặc asset thay đổi |
